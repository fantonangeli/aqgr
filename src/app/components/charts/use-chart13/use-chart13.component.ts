...
@Component({
  ...
  template: `
    <app-stacked-columns01 [series]="series" yAxisTitle="Number of gene banks reported" [legendEnabled]="false" *ngIf="series.length" [height]="300" fontStyleItalic="true"></app-stacked-columns01>
  `,
  styles: []
})

...
@Component({
  ...
  template: `
    <app-columns01 [series]="series" *ngIf="series.length" [height]="300" yAxisTitle="No. of gene banks reported by all countries" [exportTitle]="exportTitle" [legendEnabled]="false"></app-columns01>
  `,
  styles: []
})

...
@Component({
  ...
  template: `
    <app-donut01 [series]="series" [totalTemplate]="'chartsLabels.common-chart14-total' | translate" unit="institutions" [legendEnabled]="false" [enableDataLabels]="true" *ngIf="series.length" [height]="300" [exportTitle]="exportTitle"></app-donut01>
  `,
  styles: []
})

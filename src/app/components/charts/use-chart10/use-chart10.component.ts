...
@Component({
  ...
  template: `
    <app-bars01 [series]="series" *ngIf="series.length" [height]="300" [xAxisTitle]="'chartsLabels.use-chart10-xAxisTitle' | translate" fontStyleItalic="true" [exportTitle]="exportTitle"></app-bars01>
  `,
  styles: []
})

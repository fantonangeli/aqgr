...
@Component({
  ...
  template: `
    <app-bars01 [series]="series" [xAxisTitle]="'chartsLabels.common-chart04-xAxisTitle' | translate" [legendEnabled]="false" *ngIf="series.length" [height]="300" fontStyleItalic="true" [exportTitle]="exportTitle"></app-bars01>
  `,
  styles: []
})

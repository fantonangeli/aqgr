...
@Component({
  ...
  template: `
    <app-columns01 yAxisTitle="Number of species reported by countries" [series]="series" *ngIf="series.length" [height]="300" [exportTitle]="exportTitle" [legendEnabled]="false"></app-columns01>
  `,
  styles: []
})

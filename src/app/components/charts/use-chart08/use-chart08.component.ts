...
@Component({
  ...
  template: `
    <app-columns01 [yAxisTitle]="'chartsLabels.use-chart08-yAxisTitle' | translate" [series]="series" *ngIf="series.length" [height]="300" [exportTitle]="exportTitle" [legendEnabled]="false"></app-columns01>
  `,
  styles: []
})

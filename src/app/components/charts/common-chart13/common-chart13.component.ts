...
@Component({
  ...
  template: `
        <app-stacked-bars01 [series]="series" *ngIf="series.length" xAxisTitle="Total number of farmed types reported by species" fontStyleItalic="true" [exportTitle]="exportTitle"></app-stacked-bars01>
    `,
  styleUrls: []
})

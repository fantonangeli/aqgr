...
@Component({
  ...
  template: `
    <app-stacked-columns01 [series]="series" [yAxisTitle]="'chartsLabels.policies-chart01-yAxisTitle' | translate" *ngIf="series.length" [height]="300" [exportTitle]="exportTitle"></app-stacked-columns01>
  `,
  styles: []
})

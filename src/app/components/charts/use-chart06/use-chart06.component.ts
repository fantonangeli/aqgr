...
@Component({
  ...
  template: `
    <app-stacked-columns01 yAxisTitle="Number of species" [series]="series" [legendEnabled]="false" *ngIf="series.length" [height]="300" [exportTitle]="exportTitle"></app-stacked-columns01>
  `,
  styles: []
})
